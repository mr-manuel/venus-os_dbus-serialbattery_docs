...
| :--------------: | :------------: | :-------------------------: | :------------------: | :-----------------------------------: | :------------------: |
| v2.9x            | v1.6.x         | OK                          | Unavailable          | Unavailable                           | OK <sup>5</sup>      |
| v3.0x - v3.4x    | v1.6.x         | OK                          | Unavailable          | Unavailable                           | OK <sup>5</sup>      |
| v3.5.x           | v1.6.x         | OK                          | OK                   | OK                                    | OK <sup>5</sup>      |
| v3.6x            | v1.6.x         | OK                          | OK                   | OK                                    | OK <sup>5</sup>      |
