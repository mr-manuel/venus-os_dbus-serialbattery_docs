...
For more details and other options, check the [`config.default.ini`](https://github.com/mr-manuel/venus-os_dbus-serialbattery/blob/v1.6.20250131/etc/dbus-serialbattery/config.default.ini).
