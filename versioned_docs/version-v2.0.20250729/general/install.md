...
| :--------------: | :------------: | :-------------------------: | :------------------: | :-----------------------------------: | :------------------: |
| v2.9x            | v2.0.x         | OK                          | Unavailable          | Unavailable                           | OK <sup>5</sup>      |
| v3.0x - v3.4x    | v2.0.x         | OK                          | Unavailable          | Unavailable                           | OK <sup>5</sup>      |
| v3.5x            | v2.0.x         | OK                          | OK                   | OK                                    | OK <sup>5</sup>      |
| v3.6x            | v2.0.x         | OK                          | OK                   | OK                                    | OK <sup>5</sup>      |
...
> 🚨 IMPORTANT! Read the [changelog](https://github.com/mr-manuel/venus-os_dbus-serialbattery/tree/v2.0.20250729/CHANGELOG.md) BEFORE updating to a new version.
...
All available options can also be found [here](https://github.com/mr-manuel/venus-os_dbus-serialbattery/tree/v2.0.20250729/dbus-serialbattery/config.default.ini).
